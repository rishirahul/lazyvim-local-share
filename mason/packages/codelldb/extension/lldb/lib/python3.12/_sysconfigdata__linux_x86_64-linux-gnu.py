...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIGURE_CFLAGS': '-march=x86-64-v2   -fPIC '
                     ' ',
 'CONFIGURE_CFLAGS_NODIST': '-fno-pie -std=c11 -Wextra -Wno-unused-parameter '
 ...
 'CONFIGURE_LDFLAGS': ' -Wl,--exclude-libs,ALL '
                      '-LModules/_hacl',
 'CONFIGURE_LDFLAGS_NODIST': '-Wl,--emit-relocs',
 ...
 'CONFIG_ARGS': "'--build=x86_64-unknown-linux-gnu' "
                ...
                "'CFLAGS=-march=x86-64-v2   -fPIC "
                " ' "
                "'LDFLAGS=  -Wl,--exclude-libs,ALL "
                "-LModules/_hacl' 'CPPFLAGS=-march=x86-64-v2  "
                ' -fPIC  '
                "'",
 ...
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            ...
                            ')]"',
 'CPPFLAGS': '-I. -I./Include -march=x86-64-v2   '
             '-fPIC  ',
 'CXX': 'clang++',
 ...
 'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code '
                    '-DNDEBUG -g -O3 -Wall -march=x86-64-v2  '
                    ' -fPIC  '
                    ' -fno-pie -std=c11 -Wextra '
                    '-Wno-unused-parameter -Wno-missing-field-initializers '
                    '-Wstrict-prototypes -Werror=implicit-function-declaration '
                    '-fvisibility=hidden '
                    '-fprofile-instr-use=/build/Python-3.12.7/code.profclangd '
                    '-I./Include/internal -I. -I./Include -march=x86-64-v2  '
                    ' -fPIC  '
                    ' -fPIC -fPIC',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 ...
 'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -O3 -Wall -march=x86-64-v2   -fPIC '
              ' ',
 'PY_CFLAGS_NODIST': '-fno-pie -std=c11 -Wextra -Wno-unused-parameter '
 ...
 'PY_CORE_LDFLAGS': ' -Wl,--exclude-libs,ALL -LModules/_hacl '
                    '-Wl,--emit-relocs',
 'PY_CPPFLAGS': '-I. -I./Include -march=x86-64-v2   '
                '-fPIC  ',
 'PY_ENABLE_SHARED': 1,
 'PY_HAVE_PERF_TRAMPOLINE': 1,
 'PY_LDFLAGS': ' -Wl,--exclude-libs,ALL -LModules/_hacl',
 'PY_LDFLAGS_NODIST': '-Wl,--emit-relocs',
